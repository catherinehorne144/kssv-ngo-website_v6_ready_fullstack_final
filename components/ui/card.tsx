...
/**
 * A flexible and reusable Card component with consistent spacing and theme support.
 */
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center justify-between px-6 border-t pt-4", className)}
      {...props}
    />
  )
}
